                        ...
                        <form method="post" action="{{ route('alokasihostname.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" name="desc" id="input-desc" class="form-control form-control-alternative{{ $errors->has('desc') ? ' is-invalid' : '' }}" placeholder="{{ __('Input Description') }}" value="{{ old('desc') }}" required autofocus>
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" name="ip" id="input-ip" class="form-control form-control-alternative{{ $errors->has('ip') ? ' is-invalid' : '' }}" placeholder="{{ __('Input IP ADDRESS') }}" value="{{ old('ip') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="number" min="0" name="cpu" id="input-cpu" class="form-control form-control-alternative{{ $errors->has('cpu') ? ' is-invalid' : '' }}" placeholder="{{ __('Input Jumlah CPU') }}" value="{{ old('cpu') }}" required autofocus>
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="number" min="0" name="memory" id="input-memory" class="form-control form-control-alternative{{ $errors->has('memory') ? ' is-invalid' : '' }}" placeholder="{{ __('Input Memory') }}" value="{{ old('memory') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="number" min="0" name="disk" id="input-disk" class="form-control form-control-alternative{{ $errors->has('disk') ? ' is-invalid' : '' }}" placeholder="{{ __('Input DISK') }}" value="{{ old('disk') }}" required autofocus>
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" name="clusterHost" id="input-cluster-host" class="form-control form-control-alternative{{ $errors->has('cluster-host') ? ' is-invalid' : '' }}" placeholder="{{ __('Input Cluster Host') }}" value="{{ old('cluster-host') }}" required autofocus>
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text"  name="dataStore" id="input-data-store" class="form-control form-control-alternative{{ $errors->has('data-store') ? ' is-invalid' : '' }}" placeholder="{{ __('Input Data Store') }}" value="{{ old('data-store') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" name="tiket" id="input-tiket" class="form-control form-control-alternative{{ $errors->has('tiket') ? ' is-invalid' : '' }}" placeholder="{{ __('Input No Tiket') }}" value="{{ old('tiket') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('keterangan') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="keterangan" id="input-keterangan" class="form-control form-control-alternative{{ $errors->has('keterangan') ? ' is-invalid' : '' }}" placeholder="{{ __('Input Keterangan') }}" value="{{ old('keterangan') }}" required autofocus>
                                ...
                                <div class="form-group">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" name="pic" id="input-pic" class="form-control form-control-alternative{{ $errors->has('pic') ? ' is-invalid' : '' }}" placeholder="{{ __('Input PIC') }}" value="{{ old('pic') }}" required autofocus>
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" name="picOpd" id="input-pic-opd" class="form-control form-control-alternative{{ $errors->has('pic-opd') ? ' is-invalid' : '' }}" placeholder="{{ __('Input PIC OPD') }}" value="{{ old('pic-opd') }}" required autofocus>
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text"  name="noBast" id="input-no-bast" class="form-control form-control-alternative{{ $errors->has('no-bast') ? ' is-invalid' : '' }}" placeholder="{{ __('Input No BAST') }}" value="{{ old('no-bast') }}" required autofocus>
